      ...
      <div className="relative z-10 w-full lg:w-3/6 h-auto lg:h-[100%] flex items-center justify-center mt-8 lg:mt-0">
        <div className="relative">
          ...
          <div className="relative bg-gradient-to-br from-slate-800 to-slate-900 rounded-2xl p-1 shadow-2xl">
            <img
              src="https://img.freepik.com/premium-vector/mystery-open-book-with-shining-pages-fantasy-book-with-magic-light-sparkles-stars-illustration_257312-3.jpg?ga=GA1.1.230981918.1717932878&semt=ais_hybrid&w=440"
